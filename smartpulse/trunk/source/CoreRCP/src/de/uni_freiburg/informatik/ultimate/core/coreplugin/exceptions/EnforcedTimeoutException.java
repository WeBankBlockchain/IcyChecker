...
/**
 * Use this exception to signal that Ultimate was terminated through an external timeout and is almost always in an
 * unstable state.
 *
...
public class EnforcedTimeoutException extends RuntimeException {
	...
	public EnforcedTimeoutException(final String arg0) {
		super(arg0);
	}
}
