 ...
 *            state type
 */
public class IntersectNwa<LETTER, STATE> extends ProductNwa<LETTER, STATE> {
	 ...
	 *             if alphabets differ
	 */
	public IntersectNwa(final INwaOutgoingLetterAndTransitionProvider<LETTER, STATE> fstOperand,
			final INwaOutgoingLetterAndTransitionProvider<LETTER, STATE> sndOperand,
			final IIntersectionStateFactory<STATE> stateFactory, final boolean assumeInSndNonFinalIsTrap)
			throws AutomataLibraryException {
