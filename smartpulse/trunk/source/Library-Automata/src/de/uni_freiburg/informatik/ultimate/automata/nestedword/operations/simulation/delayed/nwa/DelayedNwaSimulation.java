...
/**
 * Simulation that realizes <b>delayed simulation</b> for reduction of a given nwa automaton.<br/>
 * Once started, results can then be get by using {@link #getResult()}.<br/>
 * <br/>
 * For more information on the type of simulation see {@link DelayedNwaGameGraph}.
 * 
...
public final class DelayedNwaSimulation<LETTER, STATE> extends DelayedSimulation<LETTER, STATE> {
	...
	/**
	 * Creates a new delayed nwa simulation with a given graph that tries to reduce the given nwa automaton using
	 * <b>delayed simulation</b>.<br/>
