...
/**
 * Iterface for NWAs with epsilon transitions.
 * 
 * 20180122 Matthias: Warning! This is a rather provisional solution. It is yet
...
public interface IEpsilonNestedWordAutomaton<LETTER, STATE> extends INestedWordAutomaton<LETTER, STATE> {
	...
	public Iterable<STATE> epsilonSuccessors(STATE state);
}
