/*
 * Copyright (C) 2015-2016 Daniel Tischner Copyright (C) 2009-2016 University of
 * Freiburg
 * 
 ...
 */
/**
 * This packages contains utility classes used for automata reduction using simulation. For example vertices used in
 * game graphs.
 */
