...
/**
 * Factory that can be used in {@link SccComputation} and that construct {@link StronglyConnectedComponent}s.
 * 
 * @author Matthias Heizmann
 *
 * @param <NODE>
 */
public class DefaultStronglyConnectedComponentFactory<NODE>
		implements IStronglyConnectedComponentFactory<NODE, StronglyConnectedComponent<NODE>> {
