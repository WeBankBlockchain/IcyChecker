...
public class LocalLValue extends LRValue {
	...
	/**
	 * A Value inside a ResultExpression that is not stored on the heap, but as a normal Boogie Variable. It may be
	 * written (call getLHS()) or read (by making it to an RValue first).
	 *
	 * @param bi
	 *            In case this LocalLValue represents a bit-field this object contains additional information. In case
	 *            this LocalLValue does not represent a bit-field we use null.
	 *
	 * @param expr
	 */
	...
	public Expression getValue() {
		return CTranslationUtil.convertLhsToExpression(mLhs);
	}
