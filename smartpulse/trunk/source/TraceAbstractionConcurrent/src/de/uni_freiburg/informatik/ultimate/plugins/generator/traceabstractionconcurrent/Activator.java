...
public class Activator {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = TraceAbstractionConcurrent.class.getPackage().getName();

	// The plug-in name
	public static final String PLUGIN_NAME = "TraceAbstractionConcurrent";
}
