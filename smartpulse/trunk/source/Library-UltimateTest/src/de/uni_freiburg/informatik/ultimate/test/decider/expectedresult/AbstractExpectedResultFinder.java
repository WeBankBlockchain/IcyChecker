/*
 * Copyright (C) 2014-2017 Matthias Heizmann (heizmann@informatik.uni-freiburg.de)
...
/**
 * Contains functionality common to all ExpectedTestResultFinders
 * 
 * @author Alexander Nutz (nutz@informatik.uni-freiburg.de)
 *
 * @param <OVERALL_RESULT>
 */
public abstract class AbstractExpectedResultFinder<OVERALL_RESULT> implements IExpectedResultFinder<OVERALL_RESULT> {
