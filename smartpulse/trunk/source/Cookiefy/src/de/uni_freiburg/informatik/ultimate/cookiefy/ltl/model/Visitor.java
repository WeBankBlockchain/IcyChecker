...
public class Visitor {
	...
	protected void visit(final And f) {
		visit((BinaryOperator) f);
	}

	protected void visit(final Finally f) {
		visit((UnaryOperator) f);
	}

	protected void visit(final Or f) {
		visit((BinaryOperator) f);
	}

	protected void visit(final Release f) {
		visit((BinaryOperator) f);
	}

	protected void visit(final Until f) {
		visit((BinaryOperator) f);
	}

	protected void visit(final WeakUntil f) {
		visit((BinaryOperator) f);
	}

	protected void visit(final Not f) {
		visit((UnaryOperator) f);
	}

	protected void visit(final Next f) {
		visit((UnaryOperator) f);
	}

	protected void visit(final Globally f) {
		visit((UnaryOperator) f);
	}

	protected void visit(final Literal f) {
		// not needed
	}

	protected void visit(final BinaryOperator f) {
		// not needed
	}

	protected void visit(final UnaryOperator f) {
		// not needed
	}
