 ...
 * 
 */
public class Svcomp17FoldersAutomataReuse extends AbstractTraceAbstractionTestSuite {
...
//	private static final int FILES_PER_DIR_LIMIT = Integer.MAX_VALUE;
	...
	private static final String[] ADDITIONAL_FOLDERS = {
//			"examples/programs/regression",
	...
	private static final String[] SETTINGS = {
		"automizer/AutomataReuse/EagerReuse.epf",
		"automizer/AutomataReuse/LazyReuse.epf",
		"automizer/AutomataReuse/NoReuse.epf",
		"automizer/AutomataReuse/StopAfterFirstViolation.epf",
	};
...
//		"AutomizerCInlineTransformed.xml",
	...
	public Collection<UltimateTestCase> createTestCases() {
		for (final DirectoryFileEndingsPair dfep : BENCHMARKS) {
			for (final String toolchain : TOOLCHAINS) {
				addTestCase(UltimateRunDefinitionGenerator.getRunDefinitionsFromTrunkRegex(
						new String[] { dfep.getDirectory() }, dfep.getFileEndings(), SETTINGS, toolchain,
		...
		for (final String setting : SETTINGS) {
			for (final String toolchain : TOOLCHAINS) {
				addTestCase(toolchain, setting, ADDITIONAL_FOLDERS, new String[] {".c", ".i"});
			}
		}
