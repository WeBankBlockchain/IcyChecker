define("ace/mode/boogie", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/tokenizer", "ace/mode/boogie_highlight_rules"], function(a, b, c) {
        var d = a("ace/lib/oop"),
        ...
        var d = a("ace/lib/oop"),
            ...
            h = function() {
                var a = e.arrayToMap("assert|assume|axiom|bool|break|bv0|bv1|bv2|bv3|bv4|bv4|bv5|bv6|bv7|bv8|bv9|call|complete|const|else|ensures|exists|false|finite|forall|free|function|goto|havoc|if|implementation|int|invariant|modifies|old|procedure|requires|return|returns|true|type|unique|var|where|while".split("|")),
