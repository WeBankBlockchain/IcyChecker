...
/**
 * An {@link IToolchainCancel} allows to signal a toolchain that it should stop processing as soon as possible.
 *
...
public interface IToolchainCancel {
	 ...
	 *
	 * @return A {@link CountDownLatch} that can signal that the toolchain actually terminated.
	 */
