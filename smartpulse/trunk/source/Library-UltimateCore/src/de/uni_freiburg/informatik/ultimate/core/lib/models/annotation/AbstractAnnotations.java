 ...
 * @deprecated Use {@link ModernAnnotations} instead and mark fields or methods without parameters with the
 *             {@link Visualizable} attribute.
 */
@Deprecated
public abstract class AbstractAnnotations implements IAnnotations {
	...
	/**
	 * Returns the array of keys of this annotation. Subclasses must override this to specify which fields are
	 * available. May not return null!
	 */
	protected abstract String[] getFieldNames();

	/**
	 * Returns for a key in the annotation the corresponding object. Subclasses must override this to return the value
					...
					public Iterator<Entry<String, Object>> iterator() {
						return new Iterator<Entry<String, Object>>() {
							...
							public Entry<String, Object> next() {
								...
								return new AbstractMap.SimpleImmutableEntry<>(field, getFieldValue(field));
							}
	...
	/**
	 * Return a string representation of this class. The default implementation will print the class name of the
	 * annotation followed by colon and the attribute map.
	 */
	@Override
