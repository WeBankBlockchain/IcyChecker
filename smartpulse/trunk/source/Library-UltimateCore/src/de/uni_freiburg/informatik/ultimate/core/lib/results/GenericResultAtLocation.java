...
public class GenericResultAtLocation extends AbstractResult implements IResultWithSeverity, IResultWithLocation {
	...
	public GenericResultAtLocation(final String plugin, final ILocation location, final String shortDescription,
			final String longDescription, final Severity severity) {
		super(plugin);
		if (location == null) {
